class ChristmasTree {
    constructor() {
        ...
        this.music.addEventListener('error', () => {
            console.error('Music loading failed');
    ...
    bindEvents() {
        ...
        this.canvas.addEventListener('click', () => {
            ...
            this.clickSound.play().catch(err => console.log('Click sound playback failed'));
        });
        ...
        document.getElementById('musicToggle').addEventListener('click', () => {
            if (this.musicPlaying) {
                ...
                this.music.play().catch(() => {
                    alert('Please allow the webpage to play music!');
                });
        ...
        document.getElementById('snowToggle').addEventListener('click', () => {
            ...
            document.getElementById('snowToggle').textContent =
                this.showSnow ? '❄️ Snow Off' : '❄️ Snow On';
        });
        ...
        document.getElementById('decorateToggle').addEventListener('click', () => {
            ...
            document.getElementById('decorateToggle').textContent =
                this.showDecorations ? '🎄 Decorations Off' : '🎄 Decorations On';
        });
    }
